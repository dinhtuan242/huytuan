                            ...
                            <tbody>
                              ...
                              //Bước 2: Hiển thị các dữ liệu trong bảng ra đây
                                ...
                                if (isset($_POST['s'])) {
                                    if ($_POST['s'] != '') {
                                    $s = $_POST['s'];
                                    $sql = "select * from tbl_post where id LIKE '%$s%' or title LIKE '%$s%' order by id desc limit $trang,8";
                                    }
                                    }else{
                                    $sql = "select * from tbl_post order by id desc limit $trang,8"; 
                                    }
                                  ...
                                  ;?>
                                    ...
                                    <td class="clearfix">
                                        ...
                                        <ul class="list-operation fl-right">
                                            <li><a href="?page=change_post&id=<?php echo $row['id'];?>" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                            <li><a href="?page=delete_post&id=<?php echo $row['id'];?>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                        </ul>
                                    </td>
                ...
                <div class="section-detail clearfix">
                    <ul id="list-paging" class="fl-right">
                        ...
                        <?php
                            ...
                            for($b=1;$b<=$sotrang;$b++){
                                echo '<li><a href="?page=list_post&trang='.$b.'" style="text-decoration:none">'.' '.$b.' '.'</a></li>';
                            }
                            ?>
                        <li>
                            <a href="" title="">></a>
