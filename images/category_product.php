                    ...
                    <?php
                        ...
                        if (isset($_POST['filter_price'])){
                            if (isset($_POST['s-product'])) {
                                if ($_POST['s-product'] != ''){
                                    ...
                                    switch($_GET['filter_price']){
                                        case "1":
                                        $sql="select * FROM tbl_product WHERE name like $s order by price desc limit $trang,8"; 
                                        break;
                                        case "2":
                                        $sql="select * FROM tbl_product WHERE name like $s  and price between 100000 and 200000 order by price desc limit $trang,8";   
                                        break;
                                        case "3":
                                        $sql="select * FROM tbl_product WHERE name like $s  and price between 200000 and 300000 order by price desc limit $trang,8";   
                                        break;
                                        case "4":
                                        $sql="select * FROM tbl_product WHERE name like $s and price between 300000 and 400000 order by price desc limit $trang,8";   
                                        break;
                                        case "5":
                                        $sql="select * FROM tbl_product WHERE name like $s and price price >= 500000 order by price desc limit $trang,8";   
                                        break;
                                        default:
                                        $sql="select * FROM tbl_product WHERE name like $s and order by price desc limit $trang,8";   
                                        break;
                                    }
                                }
                            }else{
                                switch($_POST['filter_price']){
                                    case "1":
                                    $sql="select * FROM tbl_product WHERE  price between 0 and 100000 order by price desc limit $trang,8"; 
                                    break;
                                    case "2":
                                    $sql="select * FROM tbl_product WHERE  price between 100000 and 200000 order by price desc limit $trang,8";   
                                    break;
                                    case "3":
                                    $sql="select * FROM tbl_product WHERE  price between 200000 and 300000 order by price desc limit $trang,8";   
                                    break;
                                    case "4":
                                    $sql="select * FROM tbl_product WHERE  price between 300000 and 400000 order by price desc limit $trang,8";   
                                    break;
                                    case "5":
                                    $sql="select * FROM tbl_product WHERE  price >= 500000 order by price desc limit $trang,8";   
                                    break;
                                    default:
                                    $sql="select * FROM tbl_product WHERE category like $id order by price desc limit $trang,8";   
                                    break;
                                } 
                            }
                        }else {
                            if (isset($_POST['s-product'])){
                                if ($_POST['s-product'] != ''){
                                    $s = $_POST['s-product'];
                                    $sql = "select * from tbl_product where id LIKE '%$s%' or name LIKE '%$s%' order by price desc limit $trang,8";
                                }
                            }else{
